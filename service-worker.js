...
// file's history.
const CACHE_NAME = 'th-workspace-v321'; // precache-fingerprint:9b97dd099b79
const PRECACHE_URLS = [
...
self.addEventListener('notificationclick', (event) => {
  ...
  const targetUrl = safeNotificationUrl(event.notification.data && event.notification.data.url, '/tools/workspace.html');
  event.waitUntil(
