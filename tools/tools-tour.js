...
const APP_TOUR_STEPS = [
  ...
  { page: '/tools/workspace.html', highlightSelector: '.th-sidebar-new, .th-bn-create', title: 'Create anything', body: 'The orange <strong>+</strong> starts anything, from any page: a job, an invoice, a quote, a quick charge, an expense (snap the receipt), income, a contact, a contract, or a review request. Faster still, type or say it at the top \u2014 \u201csink leak for Sarah tomorrow 2pm\u201d or \u201cinvoice Tom $85\u201d \u2014 and the right form opens filled in. On a computer it is the <strong>New</strong> button at the top of the sidebar, or just press <strong>N</strong> and start typing.' },
