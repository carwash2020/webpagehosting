...
// bottom bar's order (Home, Jobs, Clients, Invoices, Finance, then the
// More sheet). Rewritten 2026-09-22 as a real tutorial: the Dashboard
// gets 6 steps (hero, inbox, actions, Business, getting around, search),
// tabbed pages get one step per tab, the rest one each -- 24 in all.
...
const APP_TOUR_STEPS = [
  ...
  { page: '/tools/workspace.html', highlightSelector: '.th-desktop-sidebar, .th-bottom-nav', title: 'Getting around', body: 'On a phone or tablet this bar is how you get anywhere: <strong>Home, Jobs, Clients, Invoices, Finance</strong>, and <strong>More</strong> for Route Planner, Runway, Contracts, Reviews, the Appliance Wiki, Dev Tools, and Settings. On a computer the same list is the sidebar on the left. Every page has a <strong>?</strong> in its header that explains that page.' },
  { page: '/tools/workspace.html', highlightSelector: '.th-sidebar-search-trigger, .th-cmdk-btn', title: 'Search anywhere', body: 'This button (or <strong>Ctrl+K</strong> / <strong>\u2318K</strong> on a computer) opens search from any page. Type a client\u2019s name to jump to their jobs, invoices, quotes, or contracts \u2014 or type what you want to do, like \u201cexpense\u201d, \u201cquote\u201d, or \u201croute\u201d, and it takes you straight there. You never have to remember which page something lives on.' },
  ...
  { page: '/tools/clients.html', highlightSelector: '#portalAccountSearch', title: 'Clients', body: 'The admin side of the client portal. Search for a client\u2019s portal account, invite someone new, and see their invoices, work requests, quotes, and referral-credit balance in one place. Tap a name for the full history page.' },
  ...
  { page: '/tools/settings.html', highlightSelector: 'a[href*="tour=1"]', title: 'Settings', body: 'Account, display density, light or dark theme, push notifications, password, and <strong>Backup &amp; Restore</strong> (a full export of everything, separate from the automatic cloud sync). Forget something from this tour? This button replays it. That is the whole app \u2014 tap Got it and get to work.' },
];
