...
- `booking-manage-link-round3.test.js` and `booking-flow-picker-and-confirm.test.js` also click `.slot-btn[2]` / `[1]`, but they wait for enough slots first and passed on the real clock inside the window.
