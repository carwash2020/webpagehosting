...
test('F31: the blueprint background moved off body\'s own background-attachment:fixed onto a real position:fixed element', () => {
  ...
  for (const file of ['index.html', 'handyman-cedar-city-ut.html', 'handyman-hurricane-ut.html', 'handyman-la-verkin-ut.html', 'handyman-leeds-ut.html', 'handyman-mesquite-nv.html', 'handyman-santa-clara-ivins-ut.html', 'handyman-st-george-ut.html', 'handyman-washington-city-ut.html']) {
...
test('F32: the landing-page hero lede is a real class, not an attribute-presence selector fighting an inline style with !important', () => {
  ...
  for (const file of ['handyman-cedar-city-ut.html', 'handyman-hurricane-ut.html', 'handyman-la-verkin-ut.html', 'handyman-leeds-ut.html', 'handyman-mesquite-nv.html', 'handyman-santa-clara-ivins-ut.html', 'handyman-st-george-ut.html', 'handyman-washington-city-ut.html']) {
    const src = fs.readFileSync(repo(file), 'utf8');
